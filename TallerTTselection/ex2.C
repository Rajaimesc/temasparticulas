void ex2(){
  ...
  tree->SetBranchAddress("mcWeight", &mcvtw);
  ...
  for (i = 0; i < nentries; i++)
    {
      ...
      //monte carlo weights
      float weight= 1000/26283.9249837;
      float_t SF= scaleFactor_PILEUP*scaleFactor_ELE*scaleFactor_MUON*scaleFactor_BTAG*scaleFactor_TRIGGER*scaleFactor_JVFSF*scaleFactor_ZVERTEX*weight;
      float_t evtw = SF*mcvtw; 
	...
	hist_MET->Fill(MET);hist_jets_eta->Fill(jet_eta[j],evtw);
  ...
  //hist_njets->Draw();
  //canvas->Print("n_jetsmc_final.pdf");

  //cutflow->Draw("");

  //canvas->SetLogy();
  //canvas->Print("cutflow_mc_postcut.pdf");

//hist_lep_pt->Draw("");
///canvas->SetLogy();
//canvas->Print("lep_pt_postcut_mc.pdf");


//hist_lep_pt30->Draw("");
//canvas->SetLogy();
//canvas->Print("lep_pt30_mc_postcut.pdf");

//hist_lep_et20->Draw("");
//canvas->SetLogy();
//canvas->Print("lep_pt_mc2_et20.pdf");

//hist_lep_eta->Draw("");
//canvas->Print("lep_eta_mc.pdf");

//hist_jets_pt->Draw("");
//canvas->SetLogy();
//canvas->Print("jets_pt_postcut_mc.pdf");

//hist_jets_eta->Draw("");
//canvas->Print("jets_eta_postcut_mc.pdf");

//hist_jets_JVF->Draw("");
//canvas->Print("jets_JVF_mc_postcut.pdf");

hist_jets_MV1->Draw("");
canvas->Print("jets_MV1_mc_postcut2.pdf");
//**probar

  
//hist_bjets_n->Draw("");
//canvas->Print("bjets_mc_postcut.pdf");

//hist_MET->Draw("");
//canvas->Print("MET_mc.pdf");


//hist_MTW->Draw("");
//canvas->Print("MTW_postcut_mc.pdf");
